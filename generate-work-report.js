...
function main() {
  ...
  console.log(
    `Date range: ${formatDateForGit(dateRange.start)} to ${formatDateForGit(dateRange.end)}`,
  );
  ...
  const outputPath = outputFile
    ...
    : path.join(
        reportDir,
        `work-report-${formatDateForFilename(dateRange.start)}-to-${formatDateForFilename(dateRange.end)}.md`,
      );
